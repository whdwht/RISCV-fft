...
# Wenxun: couldn't find vias, need to check out
# source $PATHtoVIAS/icc_route_options.tcl
...
# Wenxun: ICC_DBL_VIA_DURING_INITIAL_ROUTING = True, thus ,no execution
