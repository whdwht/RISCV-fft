...
# Wenxun: CUSTOM_CLOCK_OPT_PSYN_PRE_SCRIPT == empty
...
# Wenxun: this part is moved to the end, after CONNECT P/G. It will source preroute_stdcells.tcl.
...
# Wenxun: ICC_PORT_PROTECTION_DIODE == empty
...
rm_abort_on_errors "clock_opt_psyn_icc"
exit
