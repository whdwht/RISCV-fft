...
# Wenxun: CUSTOM_CLOCK_OPT_ROUTE_PRE_CTO_SCRIPT == empty
...
# Wenxun: ICC_POST_CLOCK_ROUTE_CTO = False
if {$ICC_POST_CLOCK_ROUTE_CTO} {
   optimize_clock_tree -routed_clock_stage detail
}

# Wenxun: ICC_CTS_SHIELD_RULE_NAME = empty
...
# Wenxun: It source my_connect_pg.tcl
...
rm_abort_on_errors "clock_opt_route_icc"
exit
