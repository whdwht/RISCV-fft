...
report_annotated_parasitics -internal_nets -list_not_annotated -max_nets 320 -constant_arcs > "not_annotated_tc_min.rpt"

#---------------- Report Section (文件名加_tc后缀, 防三角互相覆盖) ----------------
check_constraints -verbose > "check_constr_tc_min.rpt"

update_timing -full
check_timing -verbose > "check_timing_tc_min.rpt"   ;# 模板笔误 -verbos 已修正

report_timing -exclude [all_outputs] -max_paths 20 -delay_type min_max -pba_mode path -derate -slack_lesser_than 100 > "timing_no_inout_tc_min.rpt"
report_disable_timing > "disabled_timing_tc_min.rpt"

# 13. 写SDF (命名带角, 避免与后续bc/wc冲突)
write_sdf my_tc_min.sdf
